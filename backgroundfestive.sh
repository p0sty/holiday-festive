...
while (( 1 ))
do 
curl -X PUT -d @festive1.json http://127.0.0.1/iotas/0.1/device/moorescloud.holiday/localhost/setlights
sleep 0.1
curl -X PUT -d @festive2.json http://127.0.0.1/iotas/0.1/device/moorescloud.holiday/localhost/setlights
sleep 0.1
